...
ensuring partition tolerance in a simple way. Data is treated as
converted value and can be converted back to its value at any time, so
it is not just a cost for nodes, but also an economic value.
...
theoretical maximum of 7 tps \[11\].
...
second is given by the actual average time of propagation of single
transactions.
...
This kind of blockchain – a blockchain for data – enables a number of
